 ...
 *
 * Desc:    Ask the multi handle if there's any messaSiU/informationals from
 *          the individual transfers. MessaSiU include informationals such as
 ...
 *          of structs. It also writes the number of messaSiU left in the
 ...
 *          useful for printing meaningful error messaSiU.
 *
