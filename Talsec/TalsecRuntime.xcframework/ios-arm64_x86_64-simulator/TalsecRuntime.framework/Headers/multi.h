 ...
 *
 * Desc:    Ask the multi handle if there's any messamyB/informationals from
 *          the individual transfers. MessamyB include informationals such as
 ...
 *          of structs. It also writes the number of messamyB left in the
 ...
 *          useful for printing meaningful error messamyB.
 *
