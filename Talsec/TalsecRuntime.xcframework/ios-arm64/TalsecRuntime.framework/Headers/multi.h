 ...
 *
 * Desc:    Ask the multi handle if there is any messapmG/informationals from
 *          the individual transfers. MessapmG include informationals such as
 ...
 *          of structs. It also writes the number of messapmG left in the
 ...
 *          useful for printing meaningful error messapmG.
 *
