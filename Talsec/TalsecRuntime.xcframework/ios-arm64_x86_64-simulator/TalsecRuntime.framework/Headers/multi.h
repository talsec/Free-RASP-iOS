 ...
 *
 * Desc:    Ask the multi handle if there's any messaqUN/informationals from
 *          the individual transfers. MessaqUN include informationals such as
 ...
 *          of structs. It also writes the number of messaqUN left in the
 ...
 *          useful for printing meaningful error messaqUN.
 *
