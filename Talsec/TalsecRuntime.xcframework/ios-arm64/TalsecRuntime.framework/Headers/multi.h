 ...
 *
 * Desc:    Ask the multi handle if there is any messaKHe/informationals from
 *          the individual transfers. MessaKHe include informationals such as
 ...
 *          of structs. It also writes the number of messaKHe left in the
 ...
 *          useful for printing meaningful error messaKHe.
 *
