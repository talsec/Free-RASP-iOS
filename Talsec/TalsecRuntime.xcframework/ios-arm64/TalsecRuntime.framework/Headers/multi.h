 ...
 *
 * Desc:    Ask the multi handle if there is any messazuO/informationals from
 *          the individual transfers. MessazuO include informationals such as
 ...
 *          of structs. It also writes the number of messazuO left in the
 ...
 *          useful for printing meaningful error messazuO.
 *
