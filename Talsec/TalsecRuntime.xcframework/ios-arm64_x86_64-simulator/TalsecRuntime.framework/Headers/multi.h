 ...
 *
 * Desc:    Ask the multi handle if there's any messaEPM/informationals from
 *          the individual transfers. MessaEPM include informationals such as
 ...
 *          of structs. It also writes the number of messaEPM left in the
 ...
 *          useful for printing meaningful error messaEPM.
 *
