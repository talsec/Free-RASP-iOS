 ...
 *
 * Desc:    Ask the multi handle if there is any messaJkX/informationals from
 *          the individual transfers. MessaJkX include informationals such as
 ...
 *          of structs. It also writes the number of messaJkX left in the
 ...
 *          useful for printing meaningful error messaJkX.
 *
