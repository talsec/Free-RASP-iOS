 ...
 *
 * Desc:    Ask the multi handle if there's any messarSO/informationals from
 *          the individual transfers. MessarSO include informationals such as
 ...
 *          of structs. It also writes the number of messarSO left in the
 ...
 *          useful for printing meaningful error messarSO.
 *
