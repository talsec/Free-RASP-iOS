 ...
 *
 * Desc:    Ask the multi handle if there is any messajRS/informationals from
 *          the individual transfers. MessajRS include informationals such as
 ...
 *          of structs. It also writes the number of messajRS left in the
 ...
 *          useful for printing meaningful error messajRS.
 *
